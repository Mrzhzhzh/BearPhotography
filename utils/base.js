...
class Base{
    ...
    request(params) {
        ...
        var baseRestUrl = 'https://weinixiong.yisuiyanghuoguo.com/api/public/index.php/api/v1/';
    ...
    uploadFile(filePath,name,formData,callback){
        ...
        wx.uploadFile({
            url: 'https://weinixiong.yisuiyanghuoguo.com/api/public/index.php/api/v1/Base/FtpFile/upload',
            filePath:filePath,
            name:name,
            formData:formData,
            success: function (res) {
